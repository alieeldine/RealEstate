                            ...
                            <form method="post" action="{{route('update.property')}}" id="myForm" enctype="multipart/form-data">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="mb-3">
                                            ...
                                            <select name="amenities_id[]" class="js-example-basic-multiple form-select" multiple="multiple" data-width="100%">
                                                ...
                                                <option value="{{ $amenity->id }}" {{ (in_array($amenity->id, $property_ami)) ? 'selected' : '' }}>{{ $amenity->amenitie_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div><!-- Col -->
                                ...
                                <div class="col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="long_descp" class="form-control" style="background-color:#99FFFF;" name="tinymce" id="tinymceExample" rows="10">{!! $property->long_descp !!}</textarea>
                                    </div>
                                </div><!-- Col -->
                                ...
                                <hr>
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check form-check-inline">
                                            ...
                                            <label class="form-check-label" for="checkInline" {{ $property->hot }}>
                                                    Hot Property 
                                            </label>
                                        </div>
								...
								<table class="table table-striped">
									...
									<tbody>
										...
										<tr>
											<td>{{ $key+1 }}</td>
											<td class="py-1">
												<img src="{{ asset($img->photo_name) }}" style="width:50px; height:50px;" alt="{{ str_replace('upload/property/multi-image/', ' ', $img->photo_name)}}" title="{{ str_replace('upload/property/multi-image/', ' ', $img->photo_name)}}">
											</td>
											<td>
